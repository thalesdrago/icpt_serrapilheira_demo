...
#tapply is useful when trying to apply a given function conditioned to an factor
...
iris_wout_outliers <- iris[!iris$Sepal.Width %in% outliers, c("Sepal.Width", "Species")]
